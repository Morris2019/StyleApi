...
namespace UrbanStyleApi.Controllers
{
    ...
    public class BookingTimesController : ControllerBase
    {
        ...
        public BookingTimesController(urbanstyleContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<BookingTime>> PostBookingTime(BookingTime bookingTime)
        {
            ...
            return CreatedAtAction("GetBookingTime", new { id = bookingTime.Id }, bookingTime);
        }
        ...
        {
            return _context.BookingTimes.Any(e => e.Id == id);
        }
    }
}
